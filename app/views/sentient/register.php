<div id="main">
   <?php if(isset($error)){
    ...
    <form id="register" action="register" method="post">
      ...
      <select  name="gender" form="register" required>
          <option value="" disabled selected>Sex:</option>
          <option value="male">Male</option>
          <option value="female">Female</option>
          <option value="other">other</option>
      </select><br>
      <select name="day" form="register" required>
      ...
      <select name="month" form="register" required>
      ...
      <select name="year" form="register" required>
