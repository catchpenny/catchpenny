            ...
            <div flex>
                <md-toolbar style="background-color: #009688;">
                    <div class="md-toolbar-tools">
                        <md-autocomplete md-selected-item="selectedItem" md-search-text="searchText" md-items="item in getMatches(searchText)" md-item-text="item.display" style="width: 100%;">
                            ...
                            <div flex layout="row">
                                <div flex>
                                    <md-card>
                                        <md-toolbar style="background-color: #009688;">
                                            <div class="md-toolbar-tools">
                                                <h2 class="md-title">CatchPenny 1st Vert</h2>
                                            </div>
                                        </md-toolbar>
                                        <md-card-content>
                                            <div layout="column" style="width:100%;">
                                                <md-list>
                                                    ...
                                                    <md-list-item class="md-2-line">
                                                        <img ng-src="http://pre05.deviantart.net/602b/th/pre/i/2012/078/c/7/sherlock_in_profile_by_beth193-d4t924h.jpg" class="md-avatar"
                                                             alt="Washed Out">
                                ...
                                <div flex>
                                    <md-card>
                                        <md-toolbar style="background-color: #009688;">
                                            <div class="md-toolbar-tools">
                                                <h2 class="md-title">CatchPenny 2nd Vert</h2>
                                            </div>
                                        </md-toolbar>
                                        <md-card-content>
                                            <div layout="column" style="width:100%;">
